...
class GrowthStrategyRepositoryImpl(GrowthStrategyRepository):
    ...
    async def fetch_growth_strategy(self, gender, age_group, mbti, topic, strength, reveal, platform, interested_influencer):
         ...
         **5. 총정리: 성장 로드맵 🗺️
         1️ **DIY! 개성 도출 (1-2개월):** 자신만의 독특한 음색, 커버 스타일, 혹은 오리지널 개성을 찾고 성장! 2️ **꾸준함! 주문형 콘텐츠 제작 (지속적):** 일정 시간 간격으로 새로운 콘텐츠를 업로드하여 팬들의 기대감을 유지하세요. 3️ **진솔한 소통 속에서 성장 (지속적):** 댓글, 메시지에 꾸준히 응답하며 팬들과 대화하고 공감대를 형성하세요! 4️ 🎉 **새 계층에게 도달하기! 협업! 2-6개월:** 다른 크리에이터들과 협업하여 새로운 팬층에게 도달하세요. 5️ 📸 **인스타그램 활용 극대화 (주 2~3번):** 스토리 기능, 하이라이트 등을 활용하여 팬들과 소통하며 알림 최대화를 유지! **응원 메시지:** 🙌 지금부터 당신의 음악이 많은 사람들에게 힘이 되고, 즐거움을 선사할 수 있도록 응원합니다! ✨
                """"""
                   ...
                   위의 "참고 답변"을 참조하여 아래의 형식에 맞추어서 "Question"에 대한 "Answer"을 출력해주세요.
                   검색된 "Context"를 사용하여 질문에 답하십시오. 답을 모를 경우, 모른다고만 말하세요.
        ...
        try:
            ...
            # 단계 8: 체인 생성
            question = interested_influencer
            chain = (
                    {"context": retriever, "question" : RunnablePassthrough(),
                     "gender": RunnablePassthrough(), "age_group": RunnablePassthrough(),
                     "mbti": RunnablePassthrough(), "topic": RunnablePassthrough(),
                     "strength": RunnablePassthrough(), "reveal": RunnablePassthrough(),
                     "platform": RunnablePassthrough(), "interested_influencer": RunnablePassthrough()
                     }
                    | prompt
                    | llm
                    | StrOutputParser()
